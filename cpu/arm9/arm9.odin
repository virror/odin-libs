...
get_instruction :: proc(idx: u32) -> u32 {
    if(CPSR.Thumb) {
...
cpu_ldm_stm :: proc(opcode: u32) -> u32 {
    ...
    if(W && u16(opcode & 0xFFFF) != 0) {
        if(L) {
            if((1 << u16(Rn)) == rlist || Rn != last) {
